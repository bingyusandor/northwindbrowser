sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("nworders.NorthwindOrderBrowser.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias nworders.NorthwindOrderBrowser.controller.ListSelector
			 */
			 ...
			 * @return {nworders.NorthwindOrderBrowser.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
