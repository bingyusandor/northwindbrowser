sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("nworders/NorthwindOrderBrowser/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("nworders.NorthwindOrderBrowser.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["nworders/NorthwindOrderBrowser/localService/mockserver"], function (mockserver) {
